                ...
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 md:p-12 max-w-5xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 animate-in fade-in slide-in-from-bottom duration-700 delay-300">
                      <Button asChild size="lg" className="bg-amavi-green hover:bg-amavi-green/90 text-white px-8 py-6 text-lg rounded-full font-bold shadow-2xl hover:scale-105 transition-all">
                        <Link href={`/noticias/${news.id}`} className="flex items-center gap-2">
                           {t('hero_carousel_read_more')}
                           <ArrowRight className="w-5 h-5" />
                        </Link>
                      </Button>
                      <Button asChild size="lg" variant="outline" className="border-white text-amavi-green hover:bg-white/10 px-8 py-6 text-lg rounded-full font-bold backdrop-blur-sm transition-all hover:text-amavi-green hover:border-amavi-green">
                        <Link href="/noticias">
                           {t('hero_carousel_view_all')}
                        </Link>
                      </Button>
                    </div>
                  </div>
